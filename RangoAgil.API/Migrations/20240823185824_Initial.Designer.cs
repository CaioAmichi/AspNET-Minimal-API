...
namespace RangoAgil.API.Migrations
{
    ...
    [Migration("20240823185824_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RangoAgil.API.Entitites.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RangoAgil.API.Entitites.Meal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IngredientMeal", b =>
                {
                    b.HasOne("RangoAgil.API.Entitites.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("IngredientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RangoAgil.API.Entitites.Meal", null)
                        .WithMany()
